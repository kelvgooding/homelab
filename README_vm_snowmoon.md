...
00 06 * * 1-7 /home/`whoami`/homelab/scripts/shell/system_info.sh > /home/`whoami`/homelab/logs/system_info_`hostname`_`date +\%Y\%m\%d`.log 2>&1

00 06 * * 1-7 /home/`whoami`/homelab/scripts/shell/package_version.sh > /home/`whoami`/homelab/logs/package_versions_`hostname`_`date +\%Y\%m\%d`.log 2>&1

00 06 * * 1-7 /home/`whoami`/homelab/scripts/shell/network_info.sh > /home/`whoami`/homelab/logs/network_info_`hostname`_`date +\%Y\%m\%d`.log 2>&1
...
@reboot sleep 60 && python3 /home/`whoami`/homelab/apps/contacts/app.py >> /home/`whoami`/homelab/logs/app_contacts_`date +\%Y\%m\%d`.log 2>&1 &

@reboot sleep 60 && python3 /home/`whoami`/homelab/apps/8ball-leaderboard/app.py >> /home/`whoami`/homelab/logs/app_8ball-leaderboard_`date +\%Y\%m\%d`.log 2>&1 &
